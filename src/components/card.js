            ...
            <div className="grid lg:grid-cols-2 2xl:grid-cols-5">
              <div className="px-8 py-12 max-w-md mx-auto sm:max-w-xl lg:px-12 lg:py-24 lg:max-w-full xl:mr-0 2xl:col-span-2">
                <div className="xl:max-w-xl">
                  ...
                  <div className="mt-4 sm:mt-6"><Link to="/" className="inline-block px-5 py-3 shadow-lg bg-indigo-500 hover:bg-indigo-300 hover:-translate-y-0.5 focus:outline-none focus:ring focus:ring-offset-2 focus:ring-indigo-500 focus:ring-opacity-50 active:bg-indigo-600 transform transition text-white rounded-lg uppercase tracking-wider font-semibold text-sm sm:text-base" href="#">{edge.node.url}</Link></div>
                </div>
              </div>
