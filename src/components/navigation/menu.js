      ...
      <header>
                          ...
                          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                              <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                  <Link to="/nosotros/que-hacemos/" className="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50 transition ease-in-out duration-150">
                                      ...
                                      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" className="hidden flex-shrink-0 h-6 w-6 text-arena-600 fillarena xl:block">
                                          <defs>
                                          </defs>
                                          <g>
		...
		C232.3,143.5,222.3,133.4,222.3,121z"/>
                                  ...
                                  <Link to="/nosotros/liderazgo/" className="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50 transition ease-in-out duration-150">
                                      ...
                                      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 402.6" className="hidden flex-shrink-0 h-6 w-6 text-arena-600 fillarena xl:block">
                                          <defs>
                                          </defs>
                                          <g>
