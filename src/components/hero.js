    ...
    return (
        <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
            ...
            <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                ...
                <Link to="/work-with-us/" className="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-indigo-700 bg-white hover:bg-indigo-50 sm:px-8">{props.primaryButton}</Link>
