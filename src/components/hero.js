...
const HeroHome = props => {
    return (
        <div className="relative bg-radial overflow-hidden shadow-xl sm:rounded-2xl sm:overflow-hidden">
           ...
           <ParticlesAnimation/>
            <div className="relative px-4 py-20 sm:px-6 sm:py-24 lg:py-40 lg:px-24">
            {/* <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8"> */}
                <h1 className="font-arena text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                    ...
                    <span className="block font-bold text-testcolor-100">{props.title2}</span>
                </h1>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-testcolor-50 sm:max-w-3xl">{props.body}</p>
                <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                    <div className="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
                    <Link to={`/insights/${props.linkUrl}`} className="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-3xl shadow-sm text-arena-700 bg-white hover:bg-testcolor-50 sm:px-8">{props.primaryButton}</Link>
