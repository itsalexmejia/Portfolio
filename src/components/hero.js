           ...
           <ParticlesAnimation/>
            ...
            {/* <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8"> */}
                ...
                <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                    ...
                    <Link to={`/insights/${props.linkUrl}`} className="flex items-center justify-center px-4 py-4 border border-transparent text-base font-medium rounded-full shadow-sm text-arena-700 bg-white hover:bg-bluearena-50 sm:px-8">{props.primaryButton}</Link>
                    <Link to="/" className="flex items-center justify-center px-4 py-4 border border-transparent text-base font-medium rounded-full shadow-sm text-white bg-bluearena-500 bg-opacity-60 hover:bg-opacity-70 sm:px-8">{props.secondaryButton}</Link>
                    </div>
                </div>
            </div>
        </div>
