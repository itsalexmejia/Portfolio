...
<div className="relative bg-indigo-800">
  <div className="absolute inset-0">
    ...
    <div className="absolute inset-0 bg-arena-800" style={{mixBlendMode: "multiply"}} aria-hidden="true"></div>
  </div>
  <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
    <h1 className="font-brandtitle text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">{props.title}</h1>
