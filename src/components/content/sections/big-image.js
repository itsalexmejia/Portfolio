    ...
    <div className="relative bg-gray-50 pt-16 overflow-hidden sm:pt-24 lg:pt-24">
      <div className="mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl">
        <div>
          ...
          <a href="https://www.linkedin.com/company/arena-analytics/jobs/" className="mt-8 w-full bg-arena-600 border border-transparent px-5 py-3 inline-flex items-center justify-center text-base font-medium rounded-3xl text-white hover:bg-brand-700 sm:mt-10 sm:w-auto" target="_blank" rel="noreferrer">Ve nuestras vacantes</a>
        </div>
