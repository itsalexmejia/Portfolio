      ...
      <div className="relative bg-white">
          ...
          <div className="relative max-w-7xl mx-auto px-4 py-8 sm:py-12 sm:px-6 lg:py-16">
              <div className="max-w-2xl mx-auto lg:max-w-none lg:mr-0 lg:ml-auto lg:w-1/2 lg:pl-10">
                  ...
                  <Link to="#" className="mt-8 w-full bg-arena-600 border border-transparent px-5 py-3 inline-flex items-center justify-center text-base font-medium rounded-3xl text-white hover:bg-brand-700 sm:mt-10 sm:w-auto">Conoce más de nosotros</Link>
