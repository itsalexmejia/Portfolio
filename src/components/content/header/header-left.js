                      ...
                      <div className="mt-10 mx-auto max-w-7xl px-4 relative z-10 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                          <div className="sm:text-center lg:text-left">
                              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                                  ...
                                  <span className="block font-arena mt-1 text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-6xl lg:leading-tight">{props.title}</span>
                              </h1>
