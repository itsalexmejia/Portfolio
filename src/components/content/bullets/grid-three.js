    ...
    <div className="py-24 bg-gray-100">
      <div className="max-w-xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
		...
		l29.9-22.4h15.7c-12.4,42.7-43.9,77.3-85.3,93.6c-3,1.2-5,4.2-5,7.4v11H288z"/>
            ...
            <Link to="/servicios/consultoria/" className={`mt-2 text-base font-medium space-x-1 text-arena-600 transition-all ease-in-out ${props.buttonShows} lg:mt-4 hover:space-x-3`}> <span>Conoce más</span> <span aria-hidden="true">&rarr;</span></Link>
