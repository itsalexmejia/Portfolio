...
const retosindus = [
  ...
  const cadenas = [
    { name: '1. Compras', icon: UsersIcon, description: 'Entendemos que una buena planeación ayuda a rentabilizar la relación con tus proveedores' },
    { name: '2. Logística', icon: UsersIcon, description: 'Ayudamos a definir la estrategia más rentable para la distribución de los productos' },
    { name: '3. Portafolio', icon: UsersIcon, description: 'Entendemos que cada categoría se comporta de manera distinta y que el surtido determina el éxito en en punto de venta' },
    { name: '4. Punto de Venta', icon: UsersIcon, description: 'El balance correcto entre inventario, espacio y margen en el punto de venta asegurando la disponibilidad (OSA)' },
