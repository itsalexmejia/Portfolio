...
const cadenas = [
    { name: '1. Proveedores', icon: TruckIcon, description: 'Entendemos que uno de los pilares para la cadena es asegurar el abasto de materiales' },
    { name: '2. Infraestructura', icon: OfficeBuildingIcon, description: 'Ayudamos a evaluar las capacidades operativas con las necesidades actuales y futuras de tu negocio' },
    { name: '3. Operaciones internas', icon: CogIcon, description: 'Alineamos los niveles tácticos y operativos en la ejecución de los planes de demanda y suministro' },
    { name: '4. Logística', icon: CubeIcon, description: 'Ayudamos a encontrar eficiencias en el gasto logístico mejorando la utilización de los activos propios o tercerizados' },
      ...
      <Layout>
          ...
          <div className="bg-gray-100">
              <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
                  ...
                  <p className="mt-4 max-w-3xl text-lg text-gray-700 opacity-80">Integrando los aprendizajes adquiridos durante más de 20 años trabajando en las industrias de Bebidas, Confitería, Lácteos y Spirits, los avances en Modelos de Planeación y Gestión, Herramientas y Ciencia de Datos, y las Mejores Prácticas de la Industria, logramos que nuestros Clientes capitalicen beneficios en:</p>
          ...
          <div className="relative bg-white py-16 sm:py-24 lg:py-20">
              <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
                  ...
                  <p className="font-arena mt-2 text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">Cadena de valor</p>
