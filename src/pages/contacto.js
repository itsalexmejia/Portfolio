      ...
      <div className="relative py-16 px-4 sm:py-24 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:py-32 lg:grid lg:grid-cols-2">
        <div className="lg:pr-8">
          <div className="max-w-md mx-auto sm:max-w-lg lg:mx-0">
            ...
            <p className="mt-4 text-lg text-gray-500 sm:mt-3">¡Nos encantaría saber de ti! Envíenos un mensaje o un correo electrónico y nos pondremos en contacto contigo</p>
            <div className="mt-12">
              <h2 className="font-arena text-2xl font-extrabold text-gray-900 sm:text-3xl">Contáctanos</h2>
              <div className="mt-9">
                <a href="tel:+525541172649" className="flex text-arena-400 hover:text-brand-500 hover:underline" target="_blank" rel="noreferrer">
                ...
                <a href="/" className="mt-6 flex text-arena-400 hover:text-brand-500 hover:underline" target="_blank" rel="noreferrer">
                  <div className="flex-shrink-0">
